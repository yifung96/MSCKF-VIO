...
switch bootstrap.det_method
    ...
    case 'orb'
        points_0 = detectORBFeatures(I_0, 'scaleFactor', bootstrap.orb.scale_factor, 'NumLevels', bootstrap.orb.num_levels); %detect        
        points_1 = detectORBFeatures(I_1, 'scaleFactor', bootstrap.orb.scale_factor, 'NumLevels', bootstrap.orb.num_levels); %detect 
...
if bootstrap.select_by_nonMax
    ...
    switch bootstrap.det_method
        ...
        case 'orb'
            points_0 = selectUniform(points_0, bootstrap.orb.num_points, size(I_0));
            points_1 = selectUniform(points_1, bootstrap.orb.num_points, size(I_1));
            points_0 = cornerPoints(points_0.Location);
